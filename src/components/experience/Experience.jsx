          ...
          <div className="experience__frontend">
            ...
            <div data-aos="fade-left" className="experience__content">
              <article className="experience__details">
                ...
                <div>
                  <h4>Making Beats</h4>
                  <small className="text-light">FL Studio, DAW</small>
                </div>
              </article>
              ...
              <article className="experience__details">
                ...
                <div>
                  <h4>MS Office</h4>
                  <small className="text-light">Word, Excel, PowerPoint</small>
                </div>
              </article>
              <article className="experience__details">
                <BsCheck2Circle className="experience__details-icon" />
              ...
              <article className="experience__details">
                ...
                <div>
                  <h4>3D Modelling</h4>
                  <small className="text-light">Maya, Unity Engine</small>
                </div>
              </article>
            </div>
          </div>
