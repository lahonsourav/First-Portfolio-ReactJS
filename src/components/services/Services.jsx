...
const Services = () => {
  ...
  return (
    <section id="services">
      <h5 data-aos="fade-down">know my</h5>
      <h2>Bio data</h2>
      <div className="container services__container">
        <article className="service">
          ...
          >
            ...
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>Standard VI to VIII : Jawahar Navodaya Vidyalaya, Dhemaji</p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
            ...
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>Took coaching classes in : Infinity Education, Lakhimpur</p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
        ...
        <article className="service">
          ...
          >
            ...
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Languages : English, Hindi, Assamese and programming languages
              </p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Creative thinking, creative design, artistic mindset, problem
                solving
              </p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Introvert with less communication skills, good at making friends
              </p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Interested in Sci-Fi, Horror, Crime-suspense, thriller movies
              </p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Interested in Space, black hole, time travel, parrallel Universe
              </p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>Photo editing and desiging ability in Photoshop and Canva</p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
        ...
        <article className="service">
          ...
          >
            ...
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Produced Beats, Mixed Mastered audio for Clients, short films
              </p>
            </li>
            <li>
              <BsCheck2 className="service__list-icon" />
            ...
            <li>
              <BsCheck2 className="service__list-icon" />
              <p>
                Painting got featured in National Art Exhibition organised by
                ONGC
              </p>
            </li>
            <li>
